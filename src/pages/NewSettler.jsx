...
function NewSettler() {
  return (
    <main className="mx-[9px] px-[10px]  border border-Neutral-200 dark:border-Neutral-700 border-y-transparent dark:border-y-transparent ">
      <div className=" h-[842px] flex flex-col gap-[24px] border-b border-Neutral-200 dark:border-Neutral-700 py-[48px] max-sm:pt-[32px]  max-sm:pb-[24px]">
        <section className="flex flex-col gap-[16px]">
          <h1 className="text-Neutral-700 dark:text-Neutral-0 font-extrabold text-[32px] leading-[130%] tracking-[-0.5px]  ">
            Newsletter
          </h1>
          <p className="flex flex-col gap-[24px] text-Neutral-600 dark:text-Neutral-400 text-[18px] leading-[150%] tracking-[-0.2px]">
          ...
          <p className="text-Neutral-700 dark:text-Neutral-0 font-semibold text-[20px] leading-[130%] tracking-[-0.5px]">
