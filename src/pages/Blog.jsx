...
function Blog() {
  ...
  return (
    <main className="mx-[9px] px-[10px]  border  dark:border-Neutral-700 border-y-transparent dark:border-y-transparent">
      <div className="border-b dark:border-Neutral-700 py-[48px] max-lg:py-[32px]">
        <section className="pb-[24px] border-b dark:border-Neutral-700">
          ...
          <p className="text-Neutral-400 text-[18px] leading-[150%] tracking-[-0.2px] mt-[6px]">
        ...
        {data.map((item) => (
          <article
            ...
            key={item.slug}
            className="flex flex-col gap-[8px] cursor-pointer py-[20px] border-b dark:border-Neutral-700 last:border-transparent"
          >
            <h2 className="text-Neutral-0 font-semibold text-[20px] leading-[130%] tracking-[-0.5px]">
              {item.title}
            </h2>
